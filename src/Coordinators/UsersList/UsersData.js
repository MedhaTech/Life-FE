...
import {
    ...
    updateMentorStatus
} from '../../Admin/store/adminMentors/actions';
...
const TicketsPage = (props) => {
    ...
    const handleSelect = (item, num) => {
        ...
        if (num == '1') {
            props.history.push({
                pathname: `/coordinator/userprofile`,
                data: item,
                dist: studentDist,
                num: num
            });
    ...
    const viewDetail = (item) => {
        props.history.push({
            pathname: '/coordinator/teacher/dashboard',
            data: item
        });
    ...
    const handleEdit = (item) => {
        ...
        props.history.push({
            pathname: `/coordinator/edit-user-profile`,
            data: item
        });
        localStorage.setItem('mentor', JSON.stringify(item));
    };
