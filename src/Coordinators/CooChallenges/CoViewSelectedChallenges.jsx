...
import '../../Admin/Challenges/ViewSelectedChallenges.scss';
...
import Select from '../../Admin/Challenges/pages/Select.jsx';
...
const ViewSelectedIdea = () => {
    ...
    const [state, setState] = useState(currentUser?.data[0]?.state_name);
    ...
    async function handleideaList() {
        ...
        const tit = status ? status : 'ALL';
        const newCo = encryptGlobal(
            JSON.stringify({
                status: tit,
                filterParams
            })
        ...
        await axios
            .get(`${URL.getidealist}Data=${newCo}`, axiosConfig)
